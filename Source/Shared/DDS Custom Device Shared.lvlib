...
<Library LVVersion="16008000">
	...
	<Item Name="Shared" Type="Folder">
		<Item Name="Types" Type="Folder">
			<Item Name="Advanced DDS Configuration.ctl" Type="VI" URL="../Advanced DDS Configuration.ctl"/>
			<Item Name="Compiled.Settings.ctl" Type="VI" URL="../Compiled.Settings.ctl"/>
			<Item Name="key Enum.ctl" Type="VI" URL="../key Enum.ctl"/>
			<Item Name="MyTopic ComplexType.ctl" Type="VI" URL="../MyTopic ComplexType.ctl"/>
			<Item Name="WriterReaderConfiguration.ctl" Type="VI" URL="../WriterReaderConfiguration.ctl"/>
		</Item>
